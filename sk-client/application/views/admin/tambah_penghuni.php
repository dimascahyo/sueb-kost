        ...
        <form action="" method="POST">
          <div class="form-container">
            ...
            <div class="form-group">
              ...
              <input type="text" id="nik" name="nik" required placeholder="Masukkan NIK"><br>
            </div>

            <div class="form-group">
              <label for="kontak">Kontak:</label>
              <input type="text" id="kontak" name="kontak" required placeholder="Masukkan Nomor Hp"><br>
            </div>

            <div class="form-group">
              <label for="alamat">Alamat:</label>
              <textarea id="alamat" rows="4" maxlength="150" name="alamat" required placeholder="Masukkan Alamat"></textarea><br>
            </div>

            <div class="form-group">
              <label for="password">Password:</label>
              <input type="password" id="password" name="password" required placeholder="Masukkan password"><br>
            </div>
          </div>
